...
【暗記型の採点基準】
- キーワードや趣旨が模範解答と合っていれば9〜10点を積極的に与える
- 表現が少し違っても意味が合っていれば8〜9点
- 一部しか合っていない → 5〜7点
- 的外れ・まったく違う → 0〜3点
- 文字量ボーナスなし

【理解型（文字量あり）の採点基準】
- 趣旨が正しく150文字以上しっかり書けている → 9〜10点
- 趣旨は合っているが説明が薄い・短い → 6〜8点
- 趣旨が少しずれている → 4〜6点
- 的外れ・適当・まったく関係ない → 0〜3点
- 文字量ボーナス：50文字以上+1点、100文字以上+2点、150文字以上+3点（最大10点）

【理解型（文字量なし）の採点基準】
- 趣旨・キーワードが合っていれば文字数に関わらず9〜10点
- 方向性は合っているが説明が不十分 → 6〜8点
- 趣旨が少しずれている → 4〜6点
- 的外れ・適当・まったく関係ない → 0〜3点
- 文字量ボーナスなし
